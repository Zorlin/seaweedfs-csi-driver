...
require (
	github.com/seaweedfs/seaweedfs v0.0.0-20240124034842-025f8eb37bdd
...
require (
	...
	google.golang.org/grpc/security/advancedtls v0.0.0-20240123191817-d66bc9b79c8c // indirect
